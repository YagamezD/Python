...
#BONUS SENSEI
adrien= Usuario("Adrien")
adrien.cuentaAhorros.deposito(100).deposito(200) .generar_interes().mostrar_info_cuenta()

print("-------")

adrien.cuentaCorriente.deposito(500).retiro(200).generar_interes().mostrar_info_cuenta()